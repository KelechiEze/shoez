      ...
      <div id="women-grid" className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        >
          {filteredProducts.map((product) => (
            <div 
              key={product.id} 
              className="bg-white rounded-xl md:rounded-3xl p-3 md:p-4 border border-pink-50/50 hover:shadow-2xl transition-all duration-500 flex flex-col group relative"
            >
              {/* Image box */}
              <div className="aspect-[4/5] bg-[#faf6f7] rounded-xl md:rounded-2xl p-4 md:p-6 mb-3 md:mb-6 flex items-center justify-center relative overflow-hidden group">
                {product.isNew && (
                ...
                <img
                  src={product.image}
                  alt={product.name}
                  className="w-full h-auto object-contain transform group-hover:scale-110 group-hover:-rotate-3 transition-all duration-700 drop-shadow-xl"
              ...
              <div className="flex-1 flex flex-col justify-between px-0 md:px-2">
                <div>
                  ...
                  <h3 className="text-[11px] md:text-sm font-black text-black tracking-tight group-hover:text-pink-400 transition-colors line-clamp-2">
                    {product.name}
                  </h3>
